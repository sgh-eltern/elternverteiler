...
module SGH
  module Elternverteiler
    class MailServer
      def initialize(server: '***REMOVED***.schickhardt-gymnasium-herrenberg.de', user: '***REMOVED***', private_key: Pathname('~/.ssh/id_rsa').expand_path.read)
        @server = server
        @user = user
...
__END__
private_key = File.read('elternverteiler_rsa')
